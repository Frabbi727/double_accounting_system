<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800">{{ __('ui.incentive.title') }}</h2>
            <a href="{{ route('incentives.create') }}" class="bg-gray-800 text-white rounded px-3 py-1.5 text-sm">{{ __('ui.incentive.new') }}</a>
        </div>
    </x-slot>
